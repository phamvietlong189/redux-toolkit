...
const CreatePost = () => {
  ...
  const initialFormData: IPost = useMemo(
    () => ({
      title: '',
      description: '',
      publishDate: '',
  ...
  const handlePublistPost = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault()
  ...
  useEffect(() => {
    setFormData(editingPost || initialFormData)
  }, [editingPost, initialFormData])

  return (
    <form onSubmit={(e) => handlePublistPost(e)}>
      <div className='mb-6'>
